  ...
  private systemPrompt(topic: string): Message {
    return {
      ...
      content: `
        ...
        3. از اصطلاحات پیچیده حقوقی خودداری کنید ولی در نوشتن عریضه نهایی از آن اصطلاحات استفاده کن
        4. وقتی اطلاعات کامل جمع آوری شد از کاربر برای نوشتن عریضه نهایی سوال کن و اگر اطلاعاتی میخواست اضافه کند اضافه کن و اگر نه عریضه نهایی رو براش بنویس
